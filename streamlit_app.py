...
pip install --force-reinstall transformers sentence-transformers torch scikit-learn
...
st.title("💰 Financial Q&A Chatbot: RAG vs Fine-Tuned")
...
st.write("- What was the company’s revenue in 2023?")
